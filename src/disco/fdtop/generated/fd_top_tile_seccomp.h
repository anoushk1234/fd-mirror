...
#ifndef HEADER_fd_src_disco_fdtop_generated_fd_top_tile_seccomp_h
#define HEADER_fd_src_disco_fdtop_generated_fd_top_tile_seccomp_h
...
#endif
static const unsigned int sock_filter_policy_fd_top_tile_instr_cnt = 36;

static void populate_sock_filter_policy_fd_top_tile( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd, unsigned int drain_output_fd) {
  FD_TEST( out_cnt >= 36 );
